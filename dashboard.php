  ...
  if ($test == 0){
    ...
    <section style="background: #A26F6E; padding:75px 0;" class="download bg-primary text-center">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h2 class="section-heading" style="font-size: 57px; margin-bottom:10px; line-height:.8;">Does someone have your belongings but you're no longer on speaking terms with them?</h2>
