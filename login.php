  ...
  <header>
        ...
        <div class="container" style="max-width:650px; margin: 0 auto;">
                    <form method="post" class="form-horizontal" role="form">
                        ...
                        <h2 style="margin: 30% 0 30px 0;">Welcome Back to Relationship Repo! <br /> Please Sign In.</h2>
                        ...
                        <div class="form-group">
                            <div class="col-sm-9">
                                <button style="margin-left:35%;" type="submit"  name="btn-login" class="btn btn-outline btn-xl page-scroll">Sign In</button>
                            </div>
                        </div>
                        </div>
                    </form> <!-- /form -->
